...
module.exports.getTraductionEnvironnement = (tx, traduction_uuid) => {
    ...
    return new Promise((resolve, reject) => {
      ...
      RETURN {traduction_uuid:n.uuid, parent_uuid:parent.uuid, definition_uuid:def.uuid, child_uuid:child.uuid} `;
        ...
        return tx.run(query, {
            traduction_uuid: traduction_uuid,
            defCode: defCode,
            labelList: labelList
        }).then(parser.parse)
        // .then(data=>{ console.log('----------------------------- getTraductionEnvironnement', data); return data})
            ...
            .catch(err => {
                ...
                reject({
                    ...
                    mess: err.mess || '_dico/delete-traduction.ctrl.js/getTraductionEnvironnement'
                });
            })
    })
}
    ...
    return new Promise((resolve, reject) => {
        ...
        return tx.run(query, env)
            ...
            .catch(err => {
                ...
                reject({
                    status: err.status || 400,
                    mess: err.mess || '_dico/delete-traduction.ctrl.js/deleteTraduction'
                });
            })
    })
}
...
module.exports.main = (req, res, next) => {
    ...
    validator.uuid(ps.traduction_uuid)
        ...
        .catch(err => {
            ...
            utils.fail(session, {
                status: err.status || 400,
                mess: err.mess || 'dico/delete-traduction.ctrl.js/main'
            }, res, tx)
        })
