...
module.exports.getColumnGraph = (tx, item_uuid) => {
    return new Promise((resolve, reject) => {
        ...
        Promise.resolve()
            .then(() => {
                defCode = commonData.getLabelByDesignation("Definition").code_label
            })
            .then(() => {
                let query = `
        ...
        RETURN list `;
            ...
            .catch(err => {
                ...
                reject({
                    ...
                    mess: err.mess || '_dico/read-extend-column-graph.ctrl.js/getColumnGraph'
                });
            })
    })
};
...
module.exports.getRowGraph = (tx, columnGraph) => {
    return new Promise((resolve, reject) => {
        ...
        Promise.resolve()
            .then(() => {
                def = commonData.getLabelByDesignation("Definition")
            })
            .then(() => {
        ...
        definition:{uuid:d${i}.uuid, value:d${i}.value, code_label:d${i}.code_label}} as list `;
            ...
            .then(data => {
                console.log('graph result', data[0]);
                return data
            })
            .then(data => resolve(data[0]))
            .catch(err => {
                ...
                reject({
                    status: err.status || 400,
                    mess: err.mess || 'dico/read-extend-column-graph.ctrl.js/getRowGraph'
                });
            })
...
module.exports.main = (req, res, next) => {
    ...
    validator.uuid(ps.item_uuid, 'ps.item_uuid')
        ...
        .catch(err => {
            ...
            utils.fail(session, {
                status: err.status || 400,
                mess: err.mess || 'dico/read-extend-column-graph.ctr.js/main'
            }, res, tx)
        })
};
