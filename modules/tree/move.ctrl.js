    ...
    return new Promise((resolve, reject) => {
      ...
      RETURN index limit 1 `;
        ...
        // .then(data=>{console.log('move data ======================================',data); return data;})
            ...
            .catch(err => {
                console.log(err);
                reject({status: err.status || 400, mess: err.mess || 'tree/move.ctrl.js/moveWithDescendant'});
            })
    })
};
/*
...
module.exports.main = (req, res, next) => {
    ...
    validator.uuid(ps.destination_uuid)
        ...
        .catch(err => {
            console.log(err);
            utils.fail(session, {status: err.status || 400, mess: err.mess || 'tree/move.ctrl.js/lose'}, res, tx)
        })
};
