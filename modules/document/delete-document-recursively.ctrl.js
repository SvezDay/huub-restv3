        ...
        tx.run(one, {idx_uuid: idx_uuid})
            ...
            .catch(err => {
                ...
                reject({
                    ...
                    mess: err.mess || 'document/delete-document-recursively.ctrl.js/deleteDocument'
                });
            })
    })
}
        ...
        // .then(data => {console.log(' ========================== data: ', data); return data; })
            .then(data => {
                if (data[0].hasOwnProperty('children')) {
                    ...
                    throw {
                        status: 400,
                        mess: 'document/delete-document-recursively.ctrl.js/documentRecursivity/ returns value'
                    }
                }
            })
            ...
            .catch(err => {
                ...
                reject({
                    status: err.status || 400,
                    mess: err.mess || 'document/delete-document-recursively.ctrl.js/documentRecursivity'
                });
            })
    })
}
...
module.exports.main = (req, res, next) => { //  Input: note_uuid  |  Output: void
    ...
    validator.uuid(ps.idx_uuid, 'ps.idx_uuid')
        ...
        .catch(err => {
            ...
            utils.fail(session, {
                status: err.status || 400,
                mess: err.mess || 'document/delete-document-recursively.ctrl.js/main'
            }, res, tx)
        })
};
