...
xdescribe('HANDLE BOOK DOCUMENT', ()=>{
  ...
  it('should create and return a new book document', (done)=>{
    chai.request('http://localhost:3200').post('/modules/document/create-document').set('x-access-token',token)
    .send({model: 'book'})
    .end((err, res)=>{
      res.should.have.status(200);
      res.body.should.be.a('object');
  ...
  it('should create and return a new book note', (done)=>{
    chai.request('http://localhost:3200').post('/modules/document/create-note').set('x-access-token',token)
  ...
  it('should read book document', (done)=>{
    chai.request('http://localhost:3200').get('/modules/document/read-document').set('x-access-token',token)
