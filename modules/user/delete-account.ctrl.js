    ...
    return new Promise((resolve, reject) => {
      ...
      `;
        tx.run(query)
            ...
            .catch(err => {
                console.log(err);
                reject({status: err.status || 400, mess: err.mess || 'user/delete-account.ctrl.js/deleteAccount'});
            })
    })
}
...
module.exports.main = (req, res, next) => {
    ...
    Promise.resolve()
        .then(() => {
            return this.deleteAccount(tx, ps.uid)
        })
        .then(() => {
        ...
        .catch(err => {
            ...
            utils.fail(session, {
                ...
                mess: err.mess || 'user/delete-account.ctrl.js/main'
            }, res, tx)
        })
