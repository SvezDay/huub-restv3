...
//       chai.request('http://localhost:3200')
//       .post('/modules/document/create-document').set('x-access-token',token).send({model:'dico'})
//       .end((err, res)=>{
//         res.should.have.status(200);
//         res.body.should.be.a('object');
//         res.body.should.have.property('token');
...
//       chai.request('http://localhost:3200')
//       .post('/modules/document/create-note').set('x-access-token',token).send({model:'dico', parent_uuid:dico.title.uuid, model:dico.index.model, code_label:8.1})
//       .end((err, res)=>{
//         dico.items = [];
...
//       chai.request('http://localhost:3200')
//       .post('/modules/document/create-note').set('x-access-token',token).send({model:'dico', parent_uuid:dico.items[0].uuid, model:dico.index.model, code_label:8.2})
//       .end((err, res)=>{
//         dico.items[0].trads = [];
...
//     it('should create trad', (done)=>{
//       chai.request('http://localhost:3200')
//       .post('/modules/document/create-note').set('x-access-token',token).send({model:'dico', parent_uuid:dico.items[0].trads[0].uuid, model:dico.index.model, code_label:8.3})
//       .end((err, res)=>{
//         dico.items[0].trads.push(res.body.data);
//         done();
//       })
...
//     it('should create trad', (done)=>{
//       chai.request('http://localhost:3200')
//       .post('/modules/document/create-note').set('x-access-token',token).send({model:'dico', parent_uuid:dico.items[1].uuid, model:dico.index.model, code_label:8.2})
//       .end((err, res)=>{
//         dico.items[1].trads = [];
...
//       chai.request('http://localhost:3200')
//       .put('/modules/games-recall-one/status').set('x-access-token',token).send({idx_uuid:dico.index.uuid, status:true, descendant:true})
//       .end((err, res)=>{
//         res.should.have.status(200);
//         done();
//       })
...
//       chai.request('http://localhost:3200')
//       .get('/modules/document/read-document').set('x-access-token',token).set('idx_uuid',dico.index.uuid)
//       .end((err, res)=>{
//         res.should.have.status(200);
...
//       chai.request('http://localhost:3200')
//       .get('/modules/games-recall-one/update-recall').set('x-access-token',token)
//       .end((err, res)=>{
//         res.should.have.status(200);
//         done();
//       })
