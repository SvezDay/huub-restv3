...
module.exports.createRecall = (tx, uid, combs) => { //comb as combinaison of q/a
    return new Promise((resolve, reject) => {
        ...
        tx.run(quer)
            ...
            .catch(err => {
                console.log(err);
                reject({status: err.status || 400, mess: err.mess || 'services/recall.request.js/createRecall'});
            })
    })
}
/*
    ...
    return new Promise((resolve, reject) => {
      ...
      `;
        ...
        tx.run(quer)
            ...
            .catch(err => {
                console.log(err);
                reject({status: err.status || 400, mess: err.mess || 'services/recall.request.js/deleteRecall'});
            })
    })
}
